    ...
    async function handleDownloadImage(imageUrl, suggestedFileName) {
      ...
      return (<>
            {!dataLoaded ? (
              ...
              <>
              <button className="absolute z-10 top-5 right-4 p-2 rounded-full bg-[#e9e9e9] hover:bg-white transition-all duration-300 cursor-pointer" onClick={() => addToFavourites()}>
